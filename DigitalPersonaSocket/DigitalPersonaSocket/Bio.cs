...
namespace Digital
{
    public partial class Bio : ServiceBase, DPFP.Capture.EventHandler
    {
        ...
        public string typeProcces = ""; // tipo de proceso que ejecutara el lector (capture/validation) 
        public string bitmapDactilar = null;
        public string dedo = "Primario";
        public string stateUserVerify = null;
        public string identificacion = "0";
        ...
        private void Process(DPFP.Sample Sample)
        {
            ...
            if (features != null)
                ...
                {
                    UpdateStatus();
                    SentData("finger", Convert.ToString(stateEnrroller), bitmapDactilar);
        ...
        public void OnComplete(object Capture, string ReaderSerialNumber, DPFP.Sample Sample)
        {
            ...
            if (appServer.SessionCount > 0)
            {
                ...
                {
                    session.Send("oncomplete");
                }
            }
            //switch (typeProcces)
            //{
            //    case "capture":      // Si typeProcces es igual capture: Ejecuta proceso de Incripcion
            //        Process(Sample);
            //        break;
            //    case "validate":    // Sino ejecuta el processo de Validación.
            //        Validate(Sample);
            //        break;
        ...
        public void SentData(string type,string state,string data) {
    ...
    public class HuellaOAD
    {
        ...
        public static List<Huella> consultarHuella(string identificacion)
        {
            using (MySqlConnection conn = InternConexionBD.ObtenerConexion())
            {
                ...
                while (_reader.Read())
                {
                    ...
                    pHuella._identificacion = (string) _reader.GetValue(0);
