...
-- Volcando estructura para tabla control_acceso.retardojusticacion
...
/*!40000 ALTER TABLE `retardojusticacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `retardojusticacion` ENABLE KEYS */;
